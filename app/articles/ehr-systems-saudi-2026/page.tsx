    ...
    <>
      <section className="py-10 md:py-14 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <Breadcrumb items={[{ label: 'الرئيسية', href: '/' }, { label: 'المقالات', href: '/articles' }, { label: 'أنظمة EHR للعيادات', href: '/articles/ehr-systems-saudi-2026' }]} />
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 md:px-6 prose prose-invert">
          ...
          <ul><li><strong>Clinic Master:</strong> الأكثر انتشاراً للعيادات الصغيرة والمتوسطة</li><li><strong>Dr. Sulaiman Al Habib HIS:</strong> قوي في التكامل مع الشبكات الصحية</li><li><strong>Athena Health:</strong> حل عالمي مع تخصيص محلي</li></ul>
        </div>
      </section>
    </>
  );
