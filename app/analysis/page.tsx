      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-2">
            <ShareButton platform="twitter" url="https://saudisaashub.pages.dev/analysis" title="Market Analysis" />
            <ShareButton platform="linkedin" url="https://saudisaashub.pages.dev/analysis" title="Analysis" />
            <ShareButton platform="whatsapp" url="https://saudisaashub.pages.dev/analysis" title="Analysis" />
            <ShareButton platform="telegram" url="https://saudisaashub.pages.dev/analysis" title="Analysis" />
            <CopyButton url="https://saudisaashub.pages.dev/analysis" />
          </div>
        </div>
